...
public class OI {
    ...
    public JoystickButton buttonFourPassReset;
    public JoystickButton buttonThreeGathererUp;
    public JoystickButton buttonThreeGathererDown;
    ...
    public OI() {
        ...
        buttonThreeGathererDown = new JoystickButton(operatorStick, 3);
        buttonThreeGathererDown.whileHeld(new MoveGathererDown());
        buttonThreeGathererUp = new JoystickButton(operatorStick, 3);
        buttonThreeGathererUp.whenReleased(new MoveGathererUp());
        buttonFourPassReset = new JoystickButton(operatorStick, 4);
        buttonFourPassReset.whenPressed(new MoveGathererUp());
