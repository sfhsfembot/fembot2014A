...
public class OI {
    ...
    public JoystickButton buttonSevenPistonPushAndRetractOnly;
    public JoystickButton buttonTenPusherRetract;
    public JoystickButton buttonElevenPushBallToPass;
    ...
    public OI() {
        ...
        buttonElevenPushBallToPass = new JoystickButton(operatorStick, 11);
        buttonElevenPushBallToPass.whenPressed(new PushBallToPass());
        buttonTenPusherRetract = new JoystickButton(operatorStick, 10);
        buttonTenPusherRetract.whenPressed(new PusherRetract());
        buttonSevenPistonPushAndRetractOnly = new JoystickButton(operatorStick, 7);
        buttonSevenPistonPushAndRetractOnly.whenPressed(new PistonPushAndRetractOnly());
        ...
        SmartDashboard.putData("PistonPushAndRetractOnly", new PistonPushAndRetractOnly());
