...
public class OI {
    ...
    public JoystickButton buttonThreeGather;
    public JoystickButton buttonThreeStopGather;
    public JoystickButton buttonTwoReadyToPass;
    public JoystickButton buttonFourPass;
    public JoystickButton buttonOneKickBallForPassing;
    ...
    public OI() {
        ...
        buttonOneKickBallForPassing = new JoystickButton(operatorStick, 1);
        buttonOneKickBallForPassing.whenPressed(new PushBallToPass());
        buttonFourPass = new JoystickButton(operatorStick, 4);
        buttonFourPass.whenPressed(new Pass());
        buttonTwoReadyToPass = new JoystickButton(operatorStick, 2);
        buttonTwoReadyToPass.whenPressed(new ReadyToPass());
        buttonThreeStopGather = new JoystickButton(operatorStick, 3);
        buttonThreeStopGather.whenReleased(new MoveGathererUp());
        buttonThreeGather = new JoystickButton(operatorStick, 3);
        buttonThreeGather.whileHeld(new MoveGathererDown());
        rightDrive = new Joystick(2);
        
        leftDrive = new Joystick(1);
        
        lowShiftButton = new JoystickButton(leftDrive, 5);
        lowShiftButton.whenPressed(new LowShift());
        highShiftButton = new JoystickButton(leftDrive, 2);
        ...
        SmartDashboard.putData("ShooterReset", new ShooterReset());
